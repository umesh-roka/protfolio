...
const LINKS = [
  {
    title: "Quick Link",
    items: ["Home", "Skill", "Project", "Contact","About","Services"],
  },
    ...
    <footer  className="relative text-white  w-full">
        ...
        <div className="grid grid-cols-1 justify-between gap-4 md:grid-cols-2">
          ...
          <div className="grid grid-cols-3 justify-between gap-4">
            {LINKS.map(({ title, items }) => (
              <ul key={title}>
                <Typography
                  ...
                  className="mb-3 font-bold uppercase text-2xl "
                >
                  {title}
                </Typography>
                {items.map((link) => (
                  <li key={link}>
                    <Typography
                      ...
                      className="py-1.5 font-normal text-lg transition-colors hover:text-blue-300"
                    >
                      {link}
                    </Typography>
                  </li>
            ...
            <div className="flex flex-col ">
              <h1 className="uppercase text-2xl font-bold ml-[50px]">Contact</h1>
      ...
      <h1>Linkeind</h1>
        ...
        <div className="mt-12 flex w-full flex-col items-center justify-center border-t  border-blue-gray-50 py-4 md:flex-row md:justify-between">
          <Typography
            variant="small"
            className="mb-4 text-center font-normal -900 md:mb-0"
          >
            &copy; {currentYear} <a href="https://material-tailwind.com/">Portfolio</a>. All
            Rights Reserved.
          </Typography>
